...
export const experiences: Experience[] = [
  {
    ...
    location: 'Remote',
    description:
      'Lead and manage DevOps team operations, driving infrastructure strategy and implementation for scalable cloud solutions.',
    achievements: [
  ...
  },
  {
    ...
    location: 'Remote',
    description:
      'Delivered end-to-end SaaS solutions for startup clients migrating to AWS cloud infrastructure.',
    achievements: [
  ...
  },
  {
    ...
    description:
      'Created comprehensive AWS CloudFormation templates for enterprise cloud deployments and Azure solutions.',
    achievements: [
