...
import { Code, Server, Settings, Activity, Shield, Cloud, Filter } from 'lucide-react'
import { skillCategories, skills, getSkillsByCategory, getSkillLevel, getSkillStats } from '../data/skills'
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-12 grid grid-cols-2 gap-4 md:grid-cols-5">
          <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-300">Total Skills</div>
          </div>
          <div className="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl">
            <div className="text-2xl font-bold text-green-600 dark:text-green-400">
              {stats.expertSkills}
            </div>
            <div className="text-xs text-gray-600 dark:text-gray-300">Expert Level</div>
          </div>
          ...
          <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-xl">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-300">Avg Level</div>
          </div>
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-xl px-6 py-4">
              {(() => {
                ...
                const IconComponent = category ? iconMap[category.icon as keyof typeof iconMap] : Filter
                return (
                  <>
